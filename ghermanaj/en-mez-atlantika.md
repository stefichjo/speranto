...
| ᴍᴏɴᴅ**ᴀʏ** | `e̞ʲ` | | ᴍᴀʀᴋ**ᴇ**ᴛ | `ɪ` |
| ᴄᴏᴍᴍ**ᴀ**  | `əʳ` | | sᴀʟ**ᴀ**ᴅ  | `ə` |
| ꜰᴏʟʟ**ᴏᴡ** | `o̞ʷ` | | ʙɪɢ**ᴏ**ᴛ  | `ə` |
| ᴠᴀʟ**ᴜᴇ**  | `ʊʷ`  | | ᴍɪɴ**ᴜ**ᴛᴇ | `ɪ` |
| | | | | |
...
| | | | | |
|-|-:|-|-|-|
| ʜᴀᴘᴘ**ʏ**  | `ɪ~ɪj`  | | ʀᴀʙʙ**ɪ**ᴛ | `ɪ` |
| ᴍᴏɴᴅ**ᴀʏ** | `e̞~e̞j` | | ᴍᴀʀᴋ**ᴇ**ᴛ | `ɪ` |
| ᴄᴏᴍᴍ**ᴀ**  | `ə~ər` | | sᴀʟ**ᴀ**ᴅ  | `ə` |
| ꜰᴏʟʟ**ᴏᴡ** | `o̞~o̞w` | | ʙɪɢ**ᴏ**ᴛ  | `ə` |
| ᴠᴀʟ**ᴜᴇ**  | `ʊ~ʊw`  | | ᴍɪɴ**ᴜ**ᴛᴇ | `ɪ` |
| | | | | |
...
| | | | | |
|-|-:|-|-|-|
| ʜᴀᴘᴘ**ʏ**  | `i~ɪj`  | | ʀᴀʙʙ**ɪ**ᴛ | `ɪ` |
| ᴍᴏɴᴅ**ᴀʏ** | `e̞j`   | | ᴍᴀʀᴋ**ᴇ**ᴛ | `ə` |
| ᴄᴏᴍᴍ**ᴀ**  | `ə~ər` | | sᴀʟ**ᴀ**ᴅ  | `ə` |
| ꜰᴏʟʟ**ᴏᴡ** | `o̞w`   | | ʙɪɢ**ᴏ**ᴛ  | `ə` |
| ᴠᴀʟ**ᴜᴇ**  | `u~ʊw`  | | ᴍɪɴ**ᴜ**ᴛᴇ | `ə` |
| | | | | |
