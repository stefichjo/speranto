...
| | | | | | | | | | | |
|-|-|-|-|-|-|-|-|-|-|-|
| ꜰʟᴇᴇᴄᴇ | `iː` | | ɴᴇᴀʀ   | `ɪə̆ʳ` | | ᴋɪᴛ   | `ɪ` | |       |     |
| ꜰᴀᴄᴇ   | `eɪ` | | sǫᴜᴀʀᴇ | `εə̆ʳ` | | ᴅʀᴇss | `ε` | |       |     |
| ᴘᴀʟᴍ   | `ɑː` | | sᴛᴀʀᴛ  | `ɑə̆ʳ` | | ʙᴀᴛʜ  | `a` | | ᴛʀᴀᴘ  | `æ` |
| ɢᴏᴀᴛ   | `oʊ` | | ꜰᴏʀᴄᴇ  | `ɔə̆ʳ` | | ᴄʟᴏᴛʜ | `ɔ` | | ʟᴏᴛ   | `ɒ` |
| ɢᴏᴏsᴇ  | `uː` | | ᴄᴜʀᴇ   | `ʊə̆ʳ` | | ꜰᴏᴏᴛ  | `ʊ` | | sᴛʀᴜᴛ | `ɐ` |
| | | | | | | | | | | |
...
| ᴘᴀʟᴍ   | `ɑː` | | sᴛᴀʀᴛ  | `ɑəʳ` | | ʙᴀᴛʜ  | `a` | | ᴛʀᴀᴘ  | `æ` |
| ɢᴏᴀᴛ   | `oʊ` | | ꜰᴏʀᴄᴇ  | `ɔəʳ` | | ᴄʟᴏᴛʜ | `ɔ` | | ʟᴏᴛ   | `ɒ` |
...
| ꜰʟᴇᴇᴄᴇ | `iː` | | ɴᴇᴀʀ   | `ɪəʳ` | | ᴋɪᴛ   | `ɪ` | |       |     |
| ꜰᴀᴄᴇ   | `eɪ` | | sǫᴜᴀʀᴇ | `εəʳ` | | ᴅʀᴇss | `ε` | |       |     |
| ᴘᴀʟᴍ   | `ɑː` | | sᴛᴀʀᴛ  | `ɑːʳ` | | ʙᴀᴛʜ  | `a` | | ᴛʀᴀᴘ  | `æ` |
| ɢᴏᴀᴛ   | `oʊ` | | ꜰᴏʀᴄᴇ  | `ɔːʳ` | | ᴄʟᴏᴛʜ | `ɔ` | | ʟᴏᴛ   | `ɒ` |
| ɢᴏᴏsᴇ  | `uː` | | ᴄᴜʀᴇ   | `ʊəʳ` | | ꜰᴏᴏᴛ  | `ʊ` | | sᴛʀᴜᴛ | `ɐ` |
| | | | | | | | | | | |
...
| ɢᴏᴀᴛ   | `oʊ` | | ꜰᴏʀᴄᴇ  | `ɔːʳ` | | ᴄʟᴏᴛʜ | `ɔː` | | ʟᴏᴛ   | `ɒ` |
| ɢᴏᴏsᴇ  | `uː` | | ᴄᴜʀᴇ   | `ʊəʳ` | | ꜰᴏᴏᴛ  | `ʊ`  | | sᴛʀᴜᴛ | `ɐ` |
| | | | | | | | | | | |
...
| | | | | | | | | | | |
|-|-|-|-|-|-|-|-|-|-|-|
| ꜰʟᴇᴇᴄᴇ | `ɪj`  | | ɴᴇᴀʀ   | `ɪəʳ` | | ᴋɪᴛ   | `ɪ`  | |       |     |
| ꜰᴀᴄᴇ   | `ej`  | | sǫᴜᴀʀᴇ | `εəʳ` | | ᴅʀᴇss | `ε`  | |       |     |
| ᴘᴀʟᴍ   | `ɑːʳ` | | sᴛᴀʀᴛ  | `ɑːʳ` | | ʙᴀᴛʜ  | `ɑː` | | ᴛʀᴀᴘ  | `æ` |
| ɢᴏᴀᴛ   | `ow`  | | ꜰᴏʀᴄᴇ  | `ɔːʳ` | | ᴄʟᴏᴛʜ | `ɒ`  | |       |     |
| ɢᴏᴏsᴇ  | `ʊw`  | | ᴄᴜʀᴇ   | `ʊəʳ` | | ꜰᴏᴏᴛ  | `ʊ`  | | sᴛʀᴜᴛ | `ɐ` |
| | | | | | | | | | | |
...
| ꜰᴀᴄᴇ   | `ej`  | | sǫᴜᴀʀᴇ | `εːʳ` | | ᴅʀᴇss | `ε`  | |       |     |
| ᴘᴀʟᴍ   |       | | sᴛᴀʀᴛ  | `ɑːʳ` | | ʙᴀᴛʜ  | `ɑː` | | ᴛʀᴀᴘ  | `æ` |
| ɢᴏᴀᴛ   | `ow`  | | ꜰᴏʀᴄᴇ  | `ɔːʳ` | | ᴄʟᴏᴛʜ | `ɒ`  | |       |     |
| ɢᴏᴏsᴇ  | `ʊw`  | | ᴄᴜʀᴇ   | `ɔːʳ` | | ꜰᴏᴏᴛ  | `ʊ`  | | sᴛʀᴜᴛ | `ɐ` |
| | | | | | | | | | | |
...
| ꜰʟᴇᴇᴄᴇ | `ɪj`  | | ɴᴇᴀʀ   | `ɪːʳ` | | ᴋɪᴛ   | `ɪ`   | |       |     |
| ꜰᴀᴄᴇ   | `ej`  | | sǫᴜᴀʀᴇ | `εːʳ` | | ᴅʀᴇss | `ε`   | |       |     |
| ᴘᴀʟᴍ   |       | | sᴛᴀʀᴛ  | `ɑːʳ` | | ʙᴀᴛʜ  | `ɑːʳ` | | ᴛʀᴀᴘ  | `æ` |
| ɢᴏᴀᴛ   | `ow`  | | ꜰᴏʀᴄᴇ  | `ɔːʳ` | | ᴄʟᴏᴛʜ | `ɒ`   | |       |     |
| ɢᴏᴏsᴇ  | `ʊw`  | | ᴄᴜʀᴇ   |       | | ꜰᴏᴏᴛ  | `ʊ`   | | sᴛʀᴜᴛ | `ɐ` |
| | | | | | | | | | | |
