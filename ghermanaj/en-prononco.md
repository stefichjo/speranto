...
| | | |
|-|-|-|
| `əl` ᴀᴘᴘ**ʟ**ᴇ | `əm` ʙᴏᴛᴛ**ᴏᴍ** | `ən` ᴄᴏᴍᴍ**ᴏɴ** |

<!--v-->

| | | |
|-|-|-|
| `ɪl` ᴀᴘᴘ**ʟ**ᴇ | `ɪm` ʙᴏᴛᴛ**ᴏᴍ** | `ɪn` ᴄᴏᴍᴍ**ᴏɴ** |

<!--v-->

| | | |
|-|-|-|
| ~~`ɪ`~~`l` ᴀᴘᴘ**ʟ**ᴇ | ~~`ɪ`~~`m` ʙᴏᴛᴛ**ᴏᴍ** | ~~`ɪ`~~`n` ᴄᴏᴍᴍ**ᴏɴ** |

<!--v-->

| | | |
|-|-|-|
| `L` ᴀᴘᴘ**ʟ**ᴇ | `M` ʙᴏᴛᴛ**ᴏᴍ** | `N` ᴄᴏᴍᴍ**ᴏɴ** |
<!-- TODO syllabic l m n -->
<!-- TODO replice COMMON with better example (where ə can be omitted) -->

<!--v-->

| | | | |
|-|-|-|-|
| `L` ᴀᴘᴘ**ʟ**ᴇ | `M` ʙᴏᴛᴛ**ᴏᴍ** | `N` ᴄᴏᴍᴍ**ᴏɴ** | `ər` ʟᴇᴛᴛ**ᴇʀ** |

<!--v-->

| | | | |
|-|-|-|-|
| `L` ᴀᴘᴘ**ʟ**ᴇ | `M` ʙᴏᴛᴛ**ᴏᴍ** | `N` ᴄᴏᴍᴍ**ᴏɴ** | `ɪr` ʟᴇᴛᴛ**ᴇʀ** |

<!--v-->

| | | | |
|-|-|-|-|
| `L` ᴀᴘᴘ**ʟ**ᴇ | `M` ʙᴏᴛᴛ**ᴏᴍ** | `N` ᴄᴏᴍᴍ**ᴏɴ** | ~~`ɪ`~~`r` ʟᴇᴛᴛ**ᴇʀ** |

<!--v-->

| | | | |
|-|-|-|-|
| `L` ᴀᴘᴘ**ʟ**ᴇ | `M` ʙᴏᴛᴛ**ᴏᴍ** | `N` ᴄᴏᴍᴍ**ᴏɴ** | `R` ʟᴇᴛᴛ**ᴇʀ** |
<!-- TODO syllabic r -->
...
| | | | |
|-|-|-|-|
| `L` ᴀᴘᴘ**ʟ**ᴇ | `M` ʙᴏᴛᴛ**ᴏᴍ** | `N` ᴄᴏᴍᴍ**ᴏɴ** | `ə` ʟᴇᴛᴛ**ᴇʀ** |
...
|-|-|-|-|
| `L` ᴀᴘᴘ**ʟ**ᴇ | `M` ʙᴏᴛᴛ**ᴏᴍ** | `N` ᴄᴏᴍᴍ**ᴏɴ** | `ə` ʟᴇᴛᴛ**ᴇʀ** |
| `l` ʜᴀᴘᴘ**ɪʟ**ʏ | `m` | `n` | `r` ᴍɪsᴛ**ᴇʀ**ʏ |
<!-- TODO m n -->
<!-- TODO rational national -->
...
|-|-|
| `ɪ` ʀᴀʙʙ**ɪ**ᴛ | `i:` ʜᴀᴘᴘ**ʏ** |
| `ɪ` ᴍᴀʀᴋ**ᴇ**ᴛ | `e̞j` ʙᴀʟʟ**ᴇᴛ** |
| `ɪ` sᴀʟ**ᴀ**ᴅ | `ə` ᴄᴏᴍᴍ**ᴀ** |
| `ɪ` ʙɪɢ**ᴏ**ᴛ | `o̞w` ꜰᴏʟʟ**ᴏᴡ** |
| `ɪ` ᴍɪɴ**ᴜ**ᴛᴇ | `u:` ᴀʀɢ**ᴜᴇ** |
